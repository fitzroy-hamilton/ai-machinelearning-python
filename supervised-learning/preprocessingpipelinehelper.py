...
from .emptycolumndropper import EmptyColumnDropper
...
#        obj_pipeline  = self.preprocessor.transformers_[3][1]
        ...
        custotrans_mask = cont_pipeline.named_steps['customtransfo']\
                                        .get_support()
        custo_inverted_mask = [not elem for elem in custotrans_mask]
        remaining_feat = pd.DataFrame(cont_cols_name)[custo_inverted_mask]
...
#        cols_name = int_cols + cont_cols + cat_nom_cols + obj_cols
        ...
        print('Columns after preprocessing:', cols_name)
